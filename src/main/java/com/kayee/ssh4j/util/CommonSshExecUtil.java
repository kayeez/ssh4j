...
public class CommonSshExecUtil {
     ...
     * @return
     */
    public static HashMap<AbstractCommand, Msg> exec(final Conn vo, AbstractCommand... commands) throws SSHExecuteException, SSHConnectionException {
     ...
     * @return
     */
    public static HashMap<AbstractCommand, Msg> exec(SSHExecRunningHandler runningHandler, SSHExecResultHandler resultHandler, final Conn connInfo, AbstractCommand... commands) throws SSHExecuteException, SSHConnectionException {
        final HashMap<AbstractCommand, Msg> result = new HashMap<>();
        ...
        try {
            for (final AbstractCommand command : commands) {
                ...
                if (command instanceof ConsoleCommand) {
                    ...
                    msg.setSuccess(execResult.isSuccess());
                    msg.setSysoutMsg(execResult.getSystemOut());
                    msg.setErrorMsg(execResult.getErrorOut());
                    ...
                    msg.setSysoutMsg("上传文件" + uploadFileCommand.getLocalFileAbsolutePath() + "->" + uploadFileCommand.getRemoteFileAbsolutePath() + "成功！");
                    msg.setSuccess(true);
                    ...
                    msg.setSysoutMsg("写服务器文件" + upload.getRemoteFileAbsolutePath() + "成功！");
                    msg.setSuccess(true);
                    ...
                    msg.setSysoutMsg("下载文件" + downloadFileCommand.getRemoteFileAbsolutePath() + "->" + downloadFileCommand.getLocalFileAbsolutePath() + "成功！");
                    msg.setSuccess(true);
                    ...
                    msg.setSysoutMsg("上传文件夹" + uploadDirCommand.getLocalDir() + "->" + uploadDirCommand.getRemoteParentDir() + "成功！");
                    msg.setSuccess(true);
                } else {
                ...
                if (!msg.isSuccess()) {
                    throw new SSHExecuteException(msg.getErrorMsg());
                }
                result.put(command, msg);
                if (resultHandler != null) {
                    resultHandler.handleMessage(command, msg);
                }
            }
        } catch (Exception e) {
